...
struct Factors
{
    ...
    static const unsigned int write_dma_tlp_size = WRITE_DMA_TLP_SIZE_4_B; /*! @F */
    static const unsigned int write_dma_tlp_count = WRITE_DMA_TLP_COUNT_4_B; /*! @F */
    static const unsigned int dma_runs = 100;
    static const bool fpga_uses_interrupts = false;
    static const bool auto_restart_dma_transactions = false;

    /* Worker - related */
    static const unsigned int worker_access_pattern = SEQ_R75_W25; /*! @F */
    static const unsigned int work_set_size = 16 * 1024; /*! @F */
