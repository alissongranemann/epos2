...
template<> struct Traits<Application>: public Traits<void>
{
    ...
    static const bool run_forever = false;
    static const bool concurrent_observer = true;
    static const unsigned int iterations = 4;
    static const unsigned int num_buffers = 2; /* Number of buffer elements in the producer size. */
};
