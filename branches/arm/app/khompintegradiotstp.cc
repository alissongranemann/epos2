...
int main () {
    ...
    wie[0] = new Wiegand(1, relay[1], new GPIO('a',4,GPIO::INPUT), new GPIO('a',6,GPIO::INPUT));
    wie[1] = new Wiegand(2, relay[2], new GPIO('d',2,GPIO::INPUT), new GPIO('d',4,GPIO::INPUT));
    wie[2] = new Wiegand(3, relay[3], new GPIO('c',5,GPIO::INPUT), new GPIO('c',6,GPIO::INPUT));
    wie[3] = new Wiegand(4, relay[4], new GPIO('b',1,GPIO::INPUT), new GPIO('b',3,GPIO::INPUT));
