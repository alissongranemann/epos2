...
public:
    eMote3_Bootloader(unsigned int channel = Traits<Cortex_M_Bootloader>::NIC_CHANNEL) : eMote3_Bootloader_Common(), _nic(), _received_msg(0), _peer(_nic.broadcast()) {
